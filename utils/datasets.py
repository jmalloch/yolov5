...
class LoadImages:  # for inference
    def __init__(self, imgs, idxs, img_size=640, stride=32):
        self.files = imgs
        self.indices = idxs
        #  idxs[0]=ems, idxs[1]=frame_idx
        self.nf = len(imgs)
        self.img_size = img_size
        self.stride = stride
        self.mode = 'image'

        assert self.nf > 0, f'No snapshots passed.'
    ...
    def __next__(self):
        ...
        ems, frame_idx = self.indices[self.count]
